...
const words = ['able', 'about', 'account', 'acid', 'across', 'act', 'addition', 'adjustment', 
                ...
                'yellow', 'yes', 'yesterday', 'you', 'young', 'android', 'deoxyribonucleicacid', 
...
const drawLetterPlaces = (word) => {
    const wordDiv = document.getElementById('playerOneWordSpaces');
    wordDiv.innerHTML = '';
